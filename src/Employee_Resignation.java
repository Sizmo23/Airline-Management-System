...
public class Employee_Resignation extends JFrame
{
    ...
    private void initialize() 
    {
		...
		JLabel Cancellation = new JLabel("EMPLOYEE RESIGNATION");
		Cancellation.setFont(new Font("Tahoma", Font.PLAIN, 31));
		Cancellation.setBounds(254, 24, 394, 38);
...
//		add(NewLabel);
	...
	JLabel PassengerNo = new JLabel("EMPLOYEE REFERENCE NO");
	PassengerNo.setFont(new Font("Tahoma", Font.PLAIN, 17));
	PassengerNo.setBounds(10, 85, 210, 50);
	...
	JLabel Flightcode = new JLabel("REASON FOR RESIGNATION: ");
